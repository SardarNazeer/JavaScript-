...
// 2. Make an object for a car with properties: brand and model. Create a method that prints: 'This car is Toyota Corolla'.
// 3. Create a student object with name and age. Add a method that prints both values using this.
...
// 8. Create a calculator object with num1 and num2. Add methods for addition and subtraction using this.
// 9. Create an object method using a normal function and another using an arrow function. Compare the value of this.
// 10. Store an object method in a variable and call it separately. Observe what happens to this.
